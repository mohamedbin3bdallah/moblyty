...
$where = ' inner join departments on products.departmentid = departments.id inner join shows on departments.showid = shows.id inner join cities on shows.cityid = cities.id order by cities.title,shows.title,departments.title,products.title ASC';
