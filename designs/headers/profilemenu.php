					...
					<div class="tabbable">
						<div class="tab-content no-space">
							...
							<?php } else { ?>
								...
								<div class="form-group">
									<label class="col-md-12 control-label list-label"><!--<i class="glyphicon glyphicon-option-horizontal"></i>--><a href="../pages/csales.php"><?php language(" ").language("sales"); ?></a></label>
								</div>
								<div class="form-group">
