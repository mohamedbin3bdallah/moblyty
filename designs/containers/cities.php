...
<?php
$data = getAllDataFromTable('id,title','cities',$where,$limit);
if(!empty($data))
{
?>
							...
							<div id="del-<?php echo $data[$i]['id'];?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
								<div class="modal-dialog modal-sm">
									<div class="modal-content">
										...
										<center>
											<button class="btn btn-danger" onclick="mydelete('<?php echo $data[$i]['id'];?>','cityid','cities','shows')" data-dismiss="modal"><?php language('agree'); ?></button>
